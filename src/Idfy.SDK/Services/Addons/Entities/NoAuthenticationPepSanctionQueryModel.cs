...
using MatchMode = Idfy.Addons.Entities.Organization.MatchMode;
...
namespace Idfy.Addons.Entities
 {
     ...
     {
         /// <summary>
         /// Origin country for the ssn (two letters ISO 3166 ) for now only NO for Norway is supported. When using ssn this is required.
         /// </summary>
