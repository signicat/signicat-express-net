namespace Idfy.Addons.Entities
{
    ...
    { 
        ...
        /// </summary>
        public OrganizationOrganizationInformationModel KeyInformation { get; set; }
        ...
        /// </summary>
        public OrganizationOrganizationOwnersModel Ownership { get; set; }

        /// <summary>
        /// List of persons that have authorization to sign for the organization
        /// </summary>
        public OrganizationOrganizationAuthorizationModel Authorities { get; set; }

        /// <summary>
        /// List of persons that have authorization to sign for the organization
        /// </summary>
        public OrganizationOrganizationAuthorizationModelLegacy Authorizations { get; set; }

        /// <summary>
        /// Financial information for the organizations including credit and accounting information
        /// </summary>
        public OrganizationOrganizationFinancialsModel Financials { get; set; }
